...
require (
	...
	buf.build/gen/go/grpc/grpc/connectrpc/go v1.17.0-20241114200633-5197c4709c1b.1 // indirect
	buf.build/gen/go/grpc/grpc/protocolbuffers/go v1.35.2-20241114200633-5197c4709c1b.1 // indirect
