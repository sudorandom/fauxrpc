...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/sudorandom/fauxrpc/private/proto/gen/stubs/v1"
	http "net/http"
	strings "strings"
)
...
var (
	stubsServiceServiceDescriptor              = v1.File_stubs_v1_stubs_service_proto.Services().ByName("StubsService")
	stubsServiceAddStubsMethodDescriptor       = stubsServiceServiceDescriptor.Methods().ByName("AddStubs")
	stubsServiceRemoveStubsMethodDescriptor    = stubsServiceServiceDescriptor.Methods().ByName("RemoveStubs")
	stubsServiceRemoveAllStubsMethodDescriptor = stubsServiceServiceDescriptor.Methods().ByName("RemoveAllStubs")
	stubsServiceListStubsMethodDescriptor      = stubsServiceServiceDescriptor.Methods().ByName("ListStubs")
)
...
func NewStubsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) StubsServiceClient {
	...
	return &stubsServiceClient{
		...
		removeAllStubs: connect.NewClient[v1.RemoveAllStubsRequest, v1.RemoveAllStubsResponse](
			...
			connect.WithSchema(stubsServiceRemoveAllStubsMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		listStubs: connect.NewClient[v1.ListStubsRequest, v1.ListStubsResponse](
			httpClient,
			baseURL+StubsServiceListStubsProcedure,
			connect.WithSchema(stubsServiceListStubsMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
	}
}
